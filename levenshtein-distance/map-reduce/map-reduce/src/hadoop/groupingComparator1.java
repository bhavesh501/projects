...
public class groupingComparator1 extends WritableComparator {
	...
	public int compare(WritableComparable w1, WritableComparable w2)
	{
		...
		String str1=t1.getSecond().toString();
		String str2=t2.getSecond().toString();
		//str1.compareTo(str2);
		System.out.println("The two strings which are getting compared are #############xxxxxxxxxxxxxxxxxx");
		Double result=similarity(str1,str2)*100;
		if(result>=70.00)
		{
			System.out.println("The two strings which are getting compared are **********************xxxxxxxxxxxxxxxxxxxx");
			return 0;
